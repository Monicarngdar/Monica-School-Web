    ...
    <?php include "includes/message-menu-inc.php"; ?>
        ...
        <div class="col-12 col-md-9 d-flex flex-column bg-white p-0">
            <div class="p-3 border-bottom text-center" style="background:#385D7B;">
                <h6 class="mb-0 fw-bold text-white">Archives</h6>
            </div>
     ...
     <!--Archives List-->
       ...
       <?php foreach($archives as $mail): ?>
             <form action="archives.php" method="post" id="form<?php  echo $mail['messageId']; ?>" class="mb-0">
                 ...
                 <div class="col-2 d-flex justify-content-center align-items-center gap-2">
                  ...
                  <!-- View button -->
                    ...
                    onclick="submitForm(<?php echo $mail['messageI d']; ?>, 'view');"
                    title="View Message"></i>
                                            
                   <!-- Archive Restore button -->
                   <i class="fa-solid fa-envelope-open-text"   
                    style="color: #6c757d; cursor: pointer;" 
                    onclick="submitForm(<?php echo $mail['messageId']; ?>, 'restore');"
                    title="Restore Message"></i>
