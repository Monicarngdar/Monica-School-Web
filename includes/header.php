...
<body>
   ...
   <!--When the user is logged in, the dashboard and email link would be shown -->
        <?php if (isset($_SESSION["username"])) {   ?>
            ...
            <a class="nav-link text-white fw-semibold" href="inbox.php?action=list">Emails</a>
        <?php }  ?>
                    ...
                    <ul class="nav flex-column">
                       ...
                       <li class="nav-item">
                        ...
                        <?php  if ($_SESSION ['userRole']==1 ):?>
                         ...
                         <li class="nav-item">
                            <a class="nav-link" href="student-attendance.php?action=list"><i class="fa-solid fa-user-clock me-2"></i> Attendance</a>
                        </li>
                          <li class="nav-item">
